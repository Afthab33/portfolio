  ...
  return (
    ...
    >
      <div className="container mx-auto px-4">
        <div className="flex flex-col items-center md:flex-row md:items-center md:justify-between gap-6">
          ...
          <div className="flex flex-col items-center md:items-start">
            ...
            <a 
              ...
              aria-label="Email Aftab Hussain"
            >
        ...
        <div className="text-center text-[10px] md:text-xs text-white/60 mt-5 md:mt-6">
          <p>© {currentYear} Aftab Hussain. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
